...
- __Application__ refers to GHF Express, the software program provided by the Company.



- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to GHF Express.
...
- By email: spiffycloud@myusc.net
